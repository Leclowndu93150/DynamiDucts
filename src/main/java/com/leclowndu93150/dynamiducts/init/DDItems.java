...
import com.leclowndu93150.dynamiducts.item.WrenchItem;
...
public class DDItems {
    ...
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(DynamiDucts.MODID);
    ...
    public static final DeferredItem<DuctBlockItem> ENERGY_DUCT_BASIC = ITEMS.register("energy_duct_basic",
            () -> new DuctBlockItem(DDBlocks.ENERGY_DUCT_BASIC.get(), new Item.Properties(), TIP_ENERGY));
    public static final DeferredItem<DuctBlockItem> ENERGY_DUCT_HARDENED = ITEMS.register("energy_duct_hardened",
            () -> new DuctBlockItem(DDBlocks.ENERGY_DUCT_HARDENED.get(), new Item.Properties(), TIP_ENERGY));
    public static final DeferredItem<DuctBlockItem> ENERGY_DUCT_REINFORCED = ITEMS.register("energy_duct_reinforced",
            () -> new DuctBlockItem(DDBlocks.ENERGY_DUCT_REINFORCED.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_ENERGY));
    public static final DeferredItem<DuctBlockItem> ENERGY_DUCT_SIGNALUM = ITEMS.register("energy_duct_signalum",
            () -> new DuctBlockItem(DDBlocks.ENERGY_DUCT_SIGNALUM.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_ENERGY));
    public static final DeferredItem<DuctBlockItem> ENERGY_DUCT_RESONANT = ITEMS.register("energy_duct_resonant",
            () -> new DuctBlockItem(DDBlocks.ENERGY_DUCT_RESONANT.get(), new Item.Properties().rarity(Rarity.RARE), TIP_ENERGY));
    public static final DeferredItem<DuctBlockItem> ENERGY_DUCT_SUPERCONDUCTOR = ITEMS.register("energy_duct_superconductor",
            () -> new DuctBlockItem(DDBlocks.ENERGY_DUCT_SUPERCONDUCTOR.get(), new Item.Properties().rarity(Rarity.RARE), TIP_ENERGY, TIP_ENERGY_SUPER));

    public static final DeferredItem<DuctBlockItem> ENERGY_DUCT_REINFORCED_EMPTY = ITEMS.register("energy_duct_reinforced_empty",
            () -> new DuctBlockItem(DDBlocks.ENERGY_DUCT_REINFORCED_EMPTY.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_CRAFTING));
    public static final DeferredItem<DuctBlockItem> ENERGY_DUCT_SIGNALUM_EMPTY = ITEMS.register("energy_duct_signalum_empty",
            () -> new DuctBlockItem(DDBlocks.ENERGY_DUCT_SIGNALUM_EMPTY.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_CRAFTING));
    public static final DeferredItem<DuctBlockItem> ENERGY_DUCT_RESONANT_EMPTY = ITEMS.register("energy_duct_resonant_empty",
            () -> new DuctBlockItem(DDBlocks.ENERGY_DUCT_RESONANT_EMPTY.get(), new Item.Properties().rarity(Rarity.RARE), TIP_CRAFTING));
    public static final DeferredItem<DuctBlockItem> ENERGY_DUCT_SUPERCONDUCTOR_EMPTY = ITEMS.register("energy_duct_superconductor_empty",
            () -> new DuctBlockItem(DDBlocks.ENERGY_DUCT_SUPERCONDUCTOR_EMPTY.get(), new Item.Properties().rarity(Rarity.RARE), TIP_CRAFTING));

    public static final DeferredItem<DuctBlockItem> FLUID_DUCT_BASIC = ITEMS.register("fluid_duct_basic",
            () -> new DuctBlockItem(DDBlocks.FLUID_DUCT_BASIC.get(), new Item.Properties(), TIP_FLUID, TIP_FLUID_BASIC));
    public static final DeferredItem<DuctBlockItem> FLUID_DUCT_BASIC_OPAQUE = ITEMS.register("fluid_duct_basic_opaque",
            () -> new DuctBlockItem(DDBlocks.FLUID_DUCT_BASIC_OPAQUE.get(), new Item.Properties(), TIP_FLUID, TIP_FLUID_BASIC));
    public static final DeferredItem<DuctBlockItem> FLUID_DUCT_HARDENED = ITEMS.register("fluid_duct_hardened",
            () -> new DuctBlockItem(DDBlocks.FLUID_DUCT_HARDENED.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_FLUID, TIP_FLUID_HARDENED));
    public static final DeferredItem<DuctBlockItem> FLUID_DUCT_HARDENED_OPAQUE = ITEMS.register("fluid_duct_hardened_opaque",
            () -> new DuctBlockItem(DDBlocks.FLUID_DUCT_HARDENED_OPAQUE.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_FLUID, TIP_FLUID_HARDENED));
    public static final DeferredItem<DuctBlockItem> FLUID_DUCT_ENERGY = ITEMS.register("fluid_duct_energy",
            () -> new DuctBlockItem(DDBlocks.FLUID_DUCT_ENERGY.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_FLUID_ENERGY));
    public static final DeferredItem<DuctBlockItem> FLUID_DUCT_ENERGY_OPAQUE = ITEMS.register("fluid_duct_energy_opaque",
            () -> new DuctBlockItem(DDBlocks.FLUID_DUCT_ENERGY_OPAQUE.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_FLUID_ENERGY));
    public static final DeferredItem<DuctBlockItem> FLUID_DUCT_SUPER = ITEMS.register("fluid_duct_super",
            () -> new DuctBlockItem(DDBlocks.FLUID_DUCT_SUPER.get(), new Item.Properties().rarity(Rarity.RARE), TIP_FLUID, TIP_FLUID_SUPER));
    public static final DeferredItem<DuctBlockItem> FLUID_DUCT_SUPER_OPAQUE = ITEMS.register("fluid_duct_super_opaque",
            () -> new DuctBlockItem(DDBlocks.FLUID_DUCT_SUPER_OPAQUE.get(), new Item.Properties().rarity(Rarity.RARE), TIP_FLUID, TIP_FLUID_SUPER));
    ...
    public static final DeferredItem<DuctBlockItem> ITEM_DUCT_FAST_OPAQUE = ITEMS.register("item_duct_fast_opaque",
            () -> new DuctBlockItem(DDBlocks.ITEM_DUCT_FAST_OPAQUE.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_ITEM, TIP_ITEM_FAST));
    public static final DeferredItem<DuctBlockItem> ITEM_DUCT_ENERGY = ITEMS.register("item_duct_energy",
            () -> new DuctBlockItem(DDBlocks.ITEM_DUCT_ENERGY.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_ITEM_ENERGY));
    public static final DeferredItem<DuctBlockItem> ITEM_DUCT_ENERGY_OPAQUE = ITEMS.register("item_duct_energy_opaque",
            () -> new DuctBlockItem(DDBlocks.ITEM_DUCT_ENERGY_OPAQUE.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_ITEM_ENERGY));
    public static final DeferredItem<DuctBlockItem> ITEM_DUCT_ENERGY_FAST = ITEMS.register("item_duct_energy_fast",
            () -> new DuctBlockItem(DDBlocks.ITEM_DUCT_ENERGY_FAST.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_ITEM_ENERGY, TIP_ITEM_FAST));
    public static final DeferredItem<DuctBlockItem> ITEM_DUCT_ENERGY_FAST_OPAQUE = ITEMS.register("item_duct_energy_fast_opaque",
            () -> new DuctBlockItem(DDBlocks.ITEM_DUCT_ENERGY_FAST_OPAQUE.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_ITEM_ENERGY, TIP_ITEM_FAST));

    public static final DeferredItem<DuctBlockItem> TRANSPORT_DUCT_BASIC = ITEMS.register("transport_duct_basic",
            () -> new DuctBlockItem(DDBlocks.TRANSPORT_DUCT_BASIC.get(), new Item.Properties().rarity(Rarity.UNCOMMON), "info.dynamiducts.duct.transport"));
    public static final DeferredItem<DuctBlockItem> TRANSPORT_DUCT_LONG_RANGE = ITEMS.register("transport_duct_long_range",
            () -> new DuctBlockItem(DDBlocks.TRANSPORT_DUCT_LONG_RANGE.get(), new Item.Properties().rarity(Rarity.UNCOMMON), "info.dynamiducts.duct.transportLongRange"));
    public static final DeferredItem<DuctBlockItem> TRANSPORT_DUCT_LINKING = ITEMS.register("transport_duct_linking",
            () -> new DuctBlockItem(DDBlocks.TRANSPORT_DUCT_LINKING.get(), new Item.Properties().rarity(Rarity.UNCOMMON), "info.dynamiducts.duct.transportCrossover"));
    public static final DeferredItem<DuctBlockItem> TRANSPORT_DUCT_FRAME = ITEMS.register("transport_duct_frame",
            () -> new DuctBlockItem(DDBlocks.TRANSPORT_DUCT_FRAME.get(), new Item.Properties().rarity(Rarity.UNCOMMON), TIP_CRAFTING));

    public static final DeferredItem<DuctBlockItem> STRUCTURAL_DUCT = ITEMS.register("structural_duct",
            () -> new DuctBlockItem(DDBlocks.STRUCTURAL_DUCT.get(), new Item.Properties(), TIP_STRUCTURE));
    public static final DeferredItem<DuctBlockItem> LUX_DUCT = ITEMS.register("lux_duct",
            () -> new DuctBlockItem(DDBlocks.LUX_DUCT.get(), new Item.Properties(), "info.dynamiducts.duct.light"));

    public static final DeferredItem<AttachmentItem> SERVO_BASIC = ITEMS.register("servo_basic",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.SERVO, AttachmentTier.BASIC, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new ServoFluid(duct, dir, AttachmentTier.BASIC), (duct, dir) -> new ServoItem(duct, dir, AttachmentTier.BASIC)), "info.dynamiducts.servo.info"));
    public static final DeferredItem<AttachmentItem> SERVO_HARDENED = ITEMS.register("servo_hardened",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.SERVO, AttachmentTier.HARDENED, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new ServoFluid(duct, dir, AttachmentTier.HARDENED), (duct, dir) -> new ServoItem(duct, dir, AttachmentTier.HARDENED)), "info.dynamiducts.servo.info"));
    public static final DeferredItem<AttachmentItem> SERVO_REINFORCED = ITEMS.register("servo_reinforced",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.SERVO, AttachmentTier.REINFORCED, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new ServoFluid(duct, dir, AttachmentTier.REINFORCED), (duct, dir) -> new ServoItem(duct, dir, AttachmentTier.REINFORCED)), "info.dynamiducts.servo.info"));
    public static final DeferredItem<AttachmentItem> SERVO_SIGNALUM = ITEMS.register("servo_signalum",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.SERVO, AttachmentTier.SIGNALUM, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new ServoFluid(duct, dir, AttachmentTier.SIGNALUM), (duct, dir) -> new ServoItem(duct, dir, AttachmentTier.SIGNALUM)), "info.dynamiducts.servo.info"));
    public static final DeferredItem<AttachmentItem> SERVO_RESONANT = ITEMS.register("servo_resonant",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.SERVO, AttachmentTier.RESONANT, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new ServoFluid(duct, dir, AttachmentTier.RESONANT), (duct, dir) -> new ServoItem(duct, dir, AttachmentTier.RESONANT)), "info.dynamiducts.servo.info"));

    public static final DeferredItem<AttachmentItem> FILTER_BASIC = ITEMS.register("filter_basic",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.FILTER, AttachmentTier.BASIC, false, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new FilterFluid(duct, dir, AttachmentTier.BASIC), (duct, dir) -> new FilterItem(duct, dir, AttachmentTier.BASIC)), "info.dynamiducts.filter.info"));
    public static final DeferredItem<AttachmentItem> FILTER_HARDENED = ITEMS.register("filter_hardened",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.FILTER, AttachmentTier.HARDENED, false, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new FilterFluid(duct, dir, AttachmentTier.HARDENED), (duct, dir) -> new FilterItem(duct, dir, AttachmentTier.HARDENED)), "info.dynamiducts.filter.info"));
    public static final DeferredItem<AttachmentItem> FILTER_REINFORCED = ITEMS.register("filter_reinforced",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.FILTER, AttachmentTier.REINFORCED, false, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new FilterFluid(duct, dir, AttachmentTier.REINFORCED), (duct, dir) -> new FilterItem(duct, dir, AttachmentTier.REINFORCED)), "info.dynamiducts.filter.info"));
    public static final DeferredItem<AttachmentItem> FILTER_SIGNALUM = ITEMS.register("filter_signalum",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.FILTER, AttachmentTier.SIGNALUM, false, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new FilterFluid(duct, dir, AttachmentTier.SIGNALUM), (duct, dir) -> new FilterItem(duct, dir, AttachmentTier.SIGNALUM)), "info.dynamiducts.filter.info"));
    public static final DeferredItem<AttachmentItem> FILTER_RESONANT = ITEMS.register("filter_resonant",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.FILTER, AttachmentTier.RESONANT, false, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new FilterFluid(duct, dir, AttachmentTier.RESONANT), (duct, dir) -> new FilterItem(duct, dir, AttachmentTier.RESONANT)), "info.dynamiducts.filter.info"));

    public static final DeferredItem<AttachmentItem> RETRIEVER_BASIC = ITEMS.register("retriever_basic",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.RETRIEVER, AttachmentTier.BASIC, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new RetrieverFluid(duct, dir, AttachmentTier.BASIC), (duct, dir) -> new RetrieverItem(duct, dir, AttachmentTier.BASIC)), "info.dynamiducts.retriever.info"));
    public static final DeferredItem<AttachmentItem> RETRIEVER_HARDENED = ITEMS.register("retriever_hardened",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.RETRIEVER, AttachmentTier.HARDENED, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new RetrieverFluid(duct, dir, AttachmentTier.HARDENED), (duct, dir) -> new RetrieverItem(duct, dir, AttachmentTier.HARDENED)), "info.dynamiducts.retriever.info"));
    public static final DeferredItem<AttachmentItem> RETRIEVER_REINFORCED = ITEMS.register("retriever_reinforced",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.RETRIEVER, AttachmentTier.REINFORCED, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new RetrieverFluid(duct, dir, AttachmentTier.REINFORCED), (duct, dir) -> new RetrieverItem(duct, dir, AttachmentTier.REINFORCED)), "info.dynamiducts.retriever.info"));
    public static final DeferredItem<AttachmentItem> RETRIEVER_SIGNALUM = ITEMS.register("retriever_signalum",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.RETRIEVER, AttachmentTier.SIGNALUM, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new RetrieverFluid(duct, dir, AttachmentTier.SIGNALUM), (duct, dir) -> new RetrieverItem(duct, dir, AttachmentTier.SIGNALUM)), "info.dynamiducts.retriever.info"));
    public static final DeferredItem<AttachmentItem> RETRIEVER_RESONANT = ITEMS.register("retriever_resonant",
            () -> new AttachmentItem(new Item.Properties(), DDTooltipHelper.AttachmentTooltipType.RETRIEVER, AttachmentTier.RESONANT, (be, side) -> AttachmentPlacementHelper.createTransferAttachment(be, side, (duct, dir) -> new RetrieverFluid(duct, dir, AttachmentTier.RESONANT), (duct, dir) -> new RetrieverItem(duct, dir, AttachmentTier.RESONANT)), "info.dynamiducts.retriever.info"));
