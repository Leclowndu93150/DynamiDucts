...
public class AttachmentItem extends Item {
    ...
    public AttachmentItem(Properties properties, DDTooltipHelper.AttachmentTooltipType tooltipType, AttachmentTier tier, BiFunction<DuctBlockEntity, Direction, Attachment> placer, String... tooltipKeys) {
        this(properties, tooltipType, tier, true, placer, tooltipKeys);
    }

    public AttachmentItem(Properties properties, DDTooltipHelper.AttachmentTooltipType tooltipType, AttachmentTier tier, boolean requiresExternalSide, BiFunction<DuctBlockEntity, Direction, Attachment> placer, String... tooltipKeys) {
        super(properties);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        DDTooltipHelper.appendAttachmentTooltip(tooltipType, tier, tooltip);
    }
}
