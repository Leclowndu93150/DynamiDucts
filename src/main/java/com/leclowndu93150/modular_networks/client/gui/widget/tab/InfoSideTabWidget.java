...
public class InfoSideTabWidget extends SideTabWidget {
    ...
    public InfoSideTabWidget(int x, int y, Supplier<List<Component>> linesSupplier) {
        super(
                x, y,
                124, 92,
                Component.translatable("info.modular_networks.information"),
                ICON_INFORMATION,
                0xE1C92F,
                0xAAAFB8,
                0xFFFFFF,
